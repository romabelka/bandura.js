    ...
    if @props.showVideo
      ...
      <div className='b-video--item video_active'>
          <div className='b-video--popup'>
            ...
            <div className='b-video--popup--wrapper'><iframe width="560" height="315" src={"https://www.youtube.com/embed/"+this.props.video.id} frameBorder="0" allowFullScreen></iframe></div>
          </div>
